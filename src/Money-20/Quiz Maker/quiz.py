...
def display():
    ...
    entry1.delete(0, END)
def Finish():
    label2 = Label(root, fg="green", width=30, borderwidth=30,text=f'Correct Answers:{Score}', font=('SansSerif 40'))
    label3 = Label(root, fg="red", width=30, borderwidth=30, text=f'Wrong Answers:{max - Score}', font=('SansSerif 40'))
    finishLabel = Label(root, fg='black', width=30, borderwidth=30, text='Quiz Completed Successfully', font=('Arial 50'))
    label2.pack()
    label3.pack()
    finishLabel.pack()
