...
def Finish():
    label = Label(root, fg="green", text="Stored Question succesfully in 'questions.json'", font=('SansSerif 40'), bg="aqua")
    finishLabel = Label(root, fg='black', width=30, borderwidth=30, text='Quiz Making Completed Successfully',font=('Arial 50'), bg="aqua")
    label.pack()
    finishLabel.pack()

myButton = Button(root, text='Submit', command=Click, fg='Blue', bg="white")
myButton.pack(pady=10)
finishButton = Button(root, text='Finish', command=Finish, fg='white', bg='black')
